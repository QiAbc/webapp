...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const [movie_reviews_rows]: any = await connection.query(movie_reviews_query);

    const totalValue = movie_reviews_rows.reduce((accumulator: any, currentObject: { rating: any; }) => {
